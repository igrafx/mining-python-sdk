# Contributing to the iGrafx P360 Live Mining SDK

Thank you for considering contributing to the iGrafx P360 Live Mining SDK!
...
> - Refer to this SDK in your project's readme
> - Mention the SDK at local meetups
...
There are several ways you can contribute to the iGrafx P360 Live Mining SDK:
...
- Open an [Issue](https://github.com/igrafx/mining-python-sdk/issues).
...
The list of labels can be found [here](https://github.com/igrafx/mining-python-sdk/labels).
...
- Read the [documentation](https://github.com/igrafx/mining-python-sdk/blob/dev/howto.md) to find out if the new feature or enhancement has already been covered.
- Perform a search amongst the [issues](https://github.com/igrafx/mining-python-sdk/issues) to see if the enhancement has already been suggested.
If it has, add a comment to the existing issue instead of opening a new one.
- Find out if your idea fits the scope of the SDK. Remember that you have to convince the developers of the benefits of this suggestion.
...
2. **Clone the repository:** Clone the forked repository to your local machine using a Git client of your choice.
   ...
   ```bash
   git clone https://github.com/igrafx/mining-python-sdk.git
   ```
...
Add relevant tests and run them to validate your changes. The tests are located in the [`tests` folder](https://github.com/igrafx/mining-python-sdk/tree/dev/igrafx_mining_sdk/tests).
The tests are organised in different files. There are tests concerning the workgroups, the projects,
the graphs, the datasources and the column mappings. Add the relevant test where you deem it best fits and add comments to describe the test.
...
Please note that by submitting a pull request, you agree to license your contribution under the MIT License mentioned in the [LICENSE](https://github.com/igrafx/mining-python-sdk/blob/dev/LICENSE) file.

If you encounter any issues or have suggestions for improvements, please open an issue on the [issue tracker](https://github.com/igrafx/mining-python-sdk/issues). We appreciate your feedback and involvement in improving this project.
