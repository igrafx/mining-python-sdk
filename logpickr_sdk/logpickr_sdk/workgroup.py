...
class Workgroup:
    ...
    def __init__(self, client_id: str, key: str, apiurl: str, authurl: str, realm_name: str = 'logpickr'):
    ...
    def login(self):
        ...
        login_url = f"{self._authurl}/auth/realms/{self._realm_name}/protocol/openid-connect/token"  # Note to self: ask if this will always be the same login url structure
        login_data = {
